...
//        let lineStart = element.axValue.index(element.axValue.startIndex, offsetBy: element.axLineStart)
//        let lineEnd = element.axValue.index(lineStart, offsetBy: element.axLineEnd - element.axLineStart)
//
