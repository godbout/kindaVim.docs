...
* text is programmatically [readable and writable](#native-apps-with-macos-accessibility-support). in this condition kV does [text manipulation](#kV-accessibility-strategy). in theory we can have the full Vim experience. in practice some moves will be currently missing. feel free to [request](#feedback-%EF%B8%8F) the ones you need.
