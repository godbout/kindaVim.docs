...
* text is programmatically [readable and writable](#user-content-native-apps-with-macos-accessibility-support). in this condition kV does [text manipulation](#kV-accessibility-strategy). in theory we can have a full Vim. in practice some moves will be currently missing. feel free to [request](#user-content-feedback-💩️) the ones you need.
