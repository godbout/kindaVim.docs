...
| Normal Mode | including count | &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; | Visual Mode | including count | 
| :---:       | :---:           | :---:                                | :---:       |     :---:       | 
| `_`         | ❌️              |                                      | `_`         | ❌️              |
| `?`         | ❌️              |                                      | `^`         |                 |
| `?<CR>`     | ❌️              |                                      | `$`         | ❌️              |
