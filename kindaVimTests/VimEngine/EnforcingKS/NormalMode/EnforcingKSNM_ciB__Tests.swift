...
class EnforcingKS_ciB__Tests: EnforcingKSNM_BaseTests {
    ...
    override func setUp() {
        ...
        kindaVimEngine.handle(keyCombination: KeyCombination(vimKey: .B), appMode: .keyMapping)
    }

}


extension EnforcingKS_ciB__Tests {
