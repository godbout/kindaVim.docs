...
class EnforcingKS_cw_Tests: EnforcingKSNM_BaseTests {
...
extension EnforcingKS_cw_Tests {
    
    func test_that_it_calls_the_correct_function_for_TextElements_on_KS() {
        kindaVimEngine.axEngine = AXEngineTextElementMock()
        applyKeyCombinationsBeingTested()

        XCTAssertEqual(ksNormalModeMock.functionCalled, "cwForTextElement()")
    }
    ...
    func test_that_it_calls_the_correct_function_for_NonTextElements_on_KS() {
        ...
        XCTAssertEqual(ksNormalModeMock.functionCalled, "cwForNonTextElement()")
    }
