...
class KS_r_Tests: KS_BaseTests {

    func test_that_ra_returns_control_d_a_left() {
        let keyCombinations = keyboardStrategy.r(with: KeyCombination(key: .a))
    ...
    func test_that_rb_returns_control_d_b_left() {
        let keyCombinations = keyboardStrategy.r(with: KeyCombination(key: .b))
    ...
    func test_that_ri_returns_control_d_i_left() {
        let keyCombinations = keyboardStrategy.r(with: KeyCombination(key: .i))
