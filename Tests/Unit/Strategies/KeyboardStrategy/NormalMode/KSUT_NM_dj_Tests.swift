...
class KS_dj_Tests: KSUT_BaseTests {
    ...
    func test_that_for_AXWebArea_dj_returns_a_big_pile_of_key_combinations() {
    ...
    func test_that_for_AXScrollArea_dj_returns_a_big_pile_of_key_combinations() {
        let keyCombinations = ksNormalMode.dj(on: .scrollArea)
