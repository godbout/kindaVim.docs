...
class UsingASNM_yiBacktick_Tests: UsingASNM_BaseTests {
    ...
    override func setUp() {
        ...
        KindaVimEngine.shared.handle(keyCombination: KeyCombination(vimKey: .backtick))
    }
    
}


extension UsingASNM_yiBacktick_Tests {
