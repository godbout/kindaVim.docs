...
class UsingASNM_yiRightParenthesis_Tests: UsingASNM_BaseTests {
...
extension UsingASNM_yiRightParenthesis_Tests {
    
    func test_that_it_calls_the_correct_function_on_accessibility_strategy() {
        XCTAssertEqual(asNormalModeMock.functionCalled, "yiRightParenthesis(on:)")
    }
